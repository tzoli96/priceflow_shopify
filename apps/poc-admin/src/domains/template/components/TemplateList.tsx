...
import { formatRelativeTime } from '@/common/utils/helpers';
import { StatusBadge, ConfirmationModal } from '@/common/components/UIComponents';
...
export function TemplateList({
  ...
  const getScopeLabel = (template: Template): string => {
    ...
    const count = scope.values?.length || 0;
